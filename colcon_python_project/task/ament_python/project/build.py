...
# Taken (nearly) verbatim from colcon_ros.task.ament_python.build
...
class AmentPythonProjectBuildTask(TaskExtensionPoint):
    """Build ROS packages with the build type 'ament_python.project'."""
    ...
    async def build(self):  # noqa: D102
        ...
        logger.info(
            ...
            "'ament_python.project'".format_map(locals()))
